...
public class ConfigurationScreen implements Screen{
	...
	public void show() {
		...
		label1 = new Label("IP ADRESS:", new LabelStyle(white30boldFont, Color.WHITE));
		...
		testButton = new TextButton("Test connection", buttonStyle);
		...
		testButton.addListener(new ChangeListener() {
			...
			public void changed(ChangeEvent event, Actor actor) {
				String msg = "Error: Connection failed";
